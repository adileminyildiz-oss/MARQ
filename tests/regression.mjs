...
const r = await page.evaluate(async () => {
  ...
  out.navAttendue = 'cockpit,demandes,parcours,espace,formulaire,etudemarche,conformite,editions,factpresta,yada,facturier,tvarembours,agenda,clients,entreprise,mlegal,mfiscal,mrh,mworkflow,mcontrol,pilotage,prestataires,services,params';
