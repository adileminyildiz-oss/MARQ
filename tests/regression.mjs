...
const r = await page.evaluate(async () => {
  ...
  out.navAttendue = 'cockpit,demandes,parcours,espace,formulaire,etudemarche,conformite,editions,factpresta,yada,facturier,tvarembours,agenda,clients,entreprise,mlegal,mcrm,mfiscal,mrh,mpaye,mdoc,mworkflow,mia,mcontrol,mreporting,marchive,pilotage,prestataires,services,params';
